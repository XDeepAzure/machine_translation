...
from src.EncoderDecoder import EncoderDecoder
from src.LossFunction import MaskedSoftmaxCELoss
from src.NetModule import Seq2SeqEncoder, Seq2SeqDecoder
from src.dataset import translationDataset
from src.device import try_gpu
from src.predict import predict, bleu
...
def train(net:nn.Module, train_loader, lr, num_epochs, tgt_vocab, device):
    '''
    ...
    for epoch in range(num_epochs):
        ...
        writer.add_scalar('loss', cross_loss, epoch)
...
if __name__ == '__main__':
    ...
    # train(net, train_loader, lr, num_epochs, tgt_vocab, device)
